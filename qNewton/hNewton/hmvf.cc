...
int main()
{
  ...
  qmvf=kv::Jackson2(itv(xx),itv(nu),itv(q))
    +(x-xx)*(kv::Jackson2(itv(x+h),itv(nu),itv(q))-kv::Jackson2(itv(x),itv(nu),itv(q)))/h;
  ...
  qmvf2=kv::Hahn_Exton(itv(xx),itv(nu),itv(q))
    +(x-xx)*(kv::Hahn_Exton(itv(x+h),itv(nu),itv(q))-kv::Hahn_Exton(itv(x),itv(nu),itv(q)))/h;
  ...
  qmvf3=kv::Ramanujan_qAiry(itv(q),itv(xx))
    +(x-xx)*(kv::Ramanujan_qAiry(itv(q),itv(x+h))-kv::Ramanujan_qAiry(itv(q),itv(x)))/h;
